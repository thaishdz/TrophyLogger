...
export class BaseError extends Error {
    ...
    public readonly isOperational: boolean; // define si es error esperado o si está gestionado


    constructor(name: string, httpCode: number, message: string, isOperational: boolean) {
        super(message);
