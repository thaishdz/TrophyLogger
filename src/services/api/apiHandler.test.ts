...
describe('Make requests to the Steam API', () => {
    ...
    it("should throw an fetch error if the Achievements request fails", async () => {
        ...
        const serviceError = new ServiceError("Failed to fetch Achievements from Steam API", "FETCH_ERROR");
                ...
                game : {
                    availableGameStats: {
                        achievements: [
                            ...
                            icongray: 'https://steamcdn-a.akamaihd.net/steamcommunity/public/images/apps/1151640/7ec4a9bed1bc7d1edbf73ddde28120c221169873.jpg'
                            }
                        ]
                    }
                }
    ...
    it("should return the games cover image.", async() => {
        ...
        const apiMockResponse = {
            data: {
                items: [
                    ...
                    id: 1151640,
                    tiny_image: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1151640/capsule_231x87.jpg?t=1736534555',
                    metascore: '',
        ...
        const resultExpected = 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1151640/capsule_231x87.jpg?t=1736534555';
